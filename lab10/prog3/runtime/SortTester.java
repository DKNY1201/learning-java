package lab10.prog3.runtime;
import lab10.prog3.util.*;

import java.io.BufferedReader;
import java.io.FileReader;
import java.util.Arrays;
import java.util.Stack;
import lab10.prog3.util.RandomPermutations;
import java.util.*;
...
public class SortTester {
	...
	private final String PACKAGE = "lab10.prog3.sortroutines";
	...
	public void runTests() {
		...
		while(!sorters.isEmpty()) {
			...
			String name = lab10.prog3.util.Util.getClassNameNoPackage(nextSorter.getClass());
