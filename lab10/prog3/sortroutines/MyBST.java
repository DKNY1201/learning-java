...
public class MyBST {
	...
	private Node root;
	private int size;
	private ArrayList<Integer> listEl;
	private int[] arrBST;
	private int index;
	...
	public int[] readIntoArray() {
	  ...
	  arrBST = new int[size()];
	  readIntoArray(root, arrBST);
	  return arrBST;
	}
	
	public void readIntoArray(Node n, int[] arr) {
	  if (n != null) {
	    readIntoArray(n.left, arr);
	    arr[index++] = n.element;
	    readIntoArray(n.right, arr);
	  }
	}
