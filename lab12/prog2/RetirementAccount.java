...
public class RetirementAccount extends Account {
	...
	public void makeWithdrawal(double amount) throws OverdrawnAccountException{
		...
		if(bal < 0){
			throw new OverdrawnAccountException("After computing penalties, your withdrawal amount exceeds your balance. Employee: " + getEmp().getName() + ". Account type: " + getAcctType());
		}
		setBalance(bal);
	}
